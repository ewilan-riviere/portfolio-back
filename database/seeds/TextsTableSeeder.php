    ...
    public function run()
    {
        Text::insert([
            [
                'slug' => 'dev-resume',
                'text' => 
                "Jeune <b>développeuse orientée back-end</b> à l'origine, j'apprécie le <b>PHP</b> utilisé <b>avec Laravel</b>, en respectant le <b>MVC</b>, pour créer des <b>API</b> séparées de la partie front-end ou des sites web mineurs avec du <b>Blade</b>.
                <br/><br/>
