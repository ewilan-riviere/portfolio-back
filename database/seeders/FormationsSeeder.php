    ...
    public function run()
    {
        ...
        foreach ($formations as $key => $formationData) {
            $formation = Formation::create([
                ...
                'type'              => array_key_exists('type', $formationData) ? $formationData['type'] : null,
                'place'             => array_key_exists('place', $formationData) ? $formationData['place'] : null,
                'place_link'        => array_key_exists('place_link', $formationData) ? $formationData['place_link'] : null,
                'vocational'        => array_key_exists('vocational', $formationData) ? $formationData['vocational'] : null,
                'vocational_link'   => array_key_exists('vocational_link', $formationData) ? $formationData['vocational_link'] : null,
                'promo'             => array_key_exists('promo', $formationData) ? $formationData['promo'] : null,
                'promo_link'        => array_key_exists('promo_link', $formationData) ? $formationData['promo_link'] : null,
                ...
                'finished'          => array_key_exists('finished', $formationData) ? $formationData['finished'] : 1,
                'display'           => array_key_exists('display', $formationData) ? $formationData['display'] : null,
            ]);
